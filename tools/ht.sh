...
#
#   исходники/calc/config.json   кто это, как называется, чем открывать
#   исходники/calc/main.ht       сам текст
#   исходники/calc/logo.png      значок
#   исходники/calc/icons/        остальные картинки
#
...
# Понимает и «calc», и «исходники/calc», и путь к самому .ht.
entry_of() {
    a=$1
    case "$a" in
        *.ht) echo "$a"; return ;;
