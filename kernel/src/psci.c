...
s64 machine_power_off(void)
{
    ...
    /*
     * Ждём коротко. Если питание снимается, оно снимается сразу; долгое
     * ожидание здесь ничего не добавляет, зато держит ядро в пустом
     * цикле и задачу — в системном вызове.
     */
