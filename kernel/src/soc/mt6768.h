 ...
 *
 * TODO-VERIFY: полный объём. Redmi Note 9 выпускался с 3 и 4 ГБ, а узел
 * memory в device-tree мы ещё не разбираем. Пока аллокатору отдаётся
 * заведомо существующая часть — 2 ГБ. Выдать несуществующую память куда
 * хуже, чем недодать: обращение к ней на телефоне не даст даже ошибки,
 * просто вернёт мусор. Точный размер возьмём из DTB на этапе 5.
 */
