...
static void draw_button(void)
{
    for (int i = 0; i < BTN_COUNT; i++) {
        ...
        text(x + 40, y + 22, 3, fg, body,
             i == BTN_REBOOT ? "ПЕРЕЗАГРУЗКА" : "ВЫКЛЮЧИТЬ");
        text(x + 40, y + 66, 2, hot ? COL_WHITE : COL_DIM, body, note);
    }
}
