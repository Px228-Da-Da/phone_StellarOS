...
| **Тактирование SPI** | ❌ не пройдено | Блок SPI0 читается нулями — не затактирован |
| **Протокол Novatek** | ❌ не начато | Прошивку в контроллер грузит хост |
